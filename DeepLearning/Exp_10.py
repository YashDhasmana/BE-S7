...
def train_step(images):
    ...
    return gen_loss, disc_loss  # Ensure the losses are returned
...
def train(dataset, epochs):
    for epoch in range(epochs):
        ...
        for image_batch in dataset:
            gen_loss, disc_loss = train_step(image_batch)  # Return the losses from train_step
        ...
        # Print the losses once per epoch
